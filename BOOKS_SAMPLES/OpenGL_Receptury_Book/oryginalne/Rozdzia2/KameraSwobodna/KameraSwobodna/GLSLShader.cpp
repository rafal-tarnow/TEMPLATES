...
void GLSLShader::LoadFromString(GLenum type, const string& source) {	
	...
	//sprawdzian, czy shader wczytuje siê prawid³owo
	GLint status;
...
void GLSLShader::CreateAndLinkProgram() {
	...
	//konsolidacja programu shaderowego i kontrola jej prawid³owoœci
	GLint status;
...
//indekser zwracaj¹cy lokalizacjê atrybutu
