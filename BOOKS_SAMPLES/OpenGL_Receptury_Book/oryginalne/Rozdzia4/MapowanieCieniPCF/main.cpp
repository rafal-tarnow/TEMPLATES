...
void OnInit() {
	...
	shader.LoadFromFile(GL_VERTEX_SHADER, "shadery/PointLightShadowMapped_PCF.vert");
	shader.LoadFromFile(GL_FRAGMENT_SHADER, "shadery/PointLightShadowMapped_PCF.frag");
	//kompilacja i konsolidacja programu shaderowego
...
int main(int argc, char** argv) {
	...
	glutCreateWindow("Mapowanie cieni PCF - OpenGL 3.3");
