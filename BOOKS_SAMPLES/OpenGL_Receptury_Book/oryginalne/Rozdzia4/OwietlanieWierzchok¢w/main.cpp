...
//wierzcho³ki i indeksy sfery (szeœcianiu)
...
void OnInit() {
	...
	//wczytywanie shaderów oœwietlania wierzcho³ków
	shader.LoadFromFile(GL_VERTEX_SHADER, "shadery/perVertexLighting.vert");
	shader.LoadFromFile(GL_FRAGMENT_SHADER, "shadery/perVertexLighting.frag");
...
int main(int argc, char** argv) {
	...
	glutCreateWindow("Oœwietlanie wierzcho³ków - OpenGL 3.3");
