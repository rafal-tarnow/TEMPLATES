...
CUnitCube::CUnitCube(const glm::vec3& col)
{
	...
	shader.LoadFromFile(GL_VERTEX_SHADER, "shadery/per_vertex_light.vert");
	shader.LoadFromFile(GL_FRAGMENT_SHADER, "shadery/per_vertex_light.frag");
...
int CUnitCube::GetTotalIndices() {
	//6 œcianek z 2 trójk¹tami po 3 wierzcho³ki w ka¿dym
	return 6*2*3;
}
