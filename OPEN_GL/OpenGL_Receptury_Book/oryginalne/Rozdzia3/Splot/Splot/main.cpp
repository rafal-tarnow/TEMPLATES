...
//ID obiektu tablicy wierzcho³ków i obiektów buforów wierzcho³ków
GLuint vaoID;
...
//tablice wierzcho³ków i indeksów dla pe³noekranowego czworok¹ta
glm::vec2 vertices[4];
GLushort indices[6];
...
void OnInit() {
	...
	*id++ =3;
	...
	//zwalnianie zajêtych wczeœniej zasobów
...
//obs³uga zdarzeñ klawiszowych w celu zmiany obrazu z filtrowanego na oryginalny 
...
int main(int argc, char** argv) {
	...
	cout<<"Wcisnij klawisz ' ', aby wlaczyæ lub wylaczyæ filtr\n";
	GL_CHECK_ERRORS
